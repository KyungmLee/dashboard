...
def goodbad_wordcloud(region):
    ...
    if region == '세종':
        ...
        wc = WordCloud(width=400, height=400, max_words=50, font_path='fonts/NanumGothic.ttf',
        ...
        wc2 = WordCloud(width=400, height=400, max_words=50, font_path='fonts/NanumGothic.ttf',
